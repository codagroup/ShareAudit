...
public class FileSystemStoreService : IFileSystemStoreService
{
    ...
    public async Task<Project> LoadProjectAsync(string path)
    {
        return await Task.Run(() =>
        {
            ...
            return serializer.Deserialize(reader) as Project ?? new(); //TODO: Handle this better
        });
    }
    ...
    private static void WriteFolderEntry(StringBuilder sb, IFolderEntry entry, string username)
    {
